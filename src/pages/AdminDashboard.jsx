...
import {
  ...
  delEvent,
  getEvents,
} from "../features/events/eventsThunk";
...
export default function AdminDashboard() {
  ...
  const handleApprove = async (id) => {
    dispatch(approveEvent({ id, approved: true }));
  };

  const handleReject = async (id) => {
    dispatch(approveEvent({ id, approved: false }));
  };
  ...
  return (
    <section className="w-full py-12 px-4 md:px-16">
      ...
      <h2 className="text-xl font-bold text-center text-emerald-600 mb-8">
        All Events
      </h2>
      {/* Search */}
      ...
      {loading ? (
        <div className="flex justify-center my-20">
          <LifeLine color="#10b981" size="large" text="Deleting..." />
        </div>
      ) : (
        <>
                ...
                <div className="space-y-6">
                  {paginated.map((e) => (
                    <motion.div
                      ...
                      className="bg-white rounded-2xl shadow-lg overflow-hidden border-l-8 border-blue-500 hover:shadow-2xl transition-all duration-300"
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                          {e.approved === 0 && (
                            <button
                              ...
                              className="bg-emerald-500 text-white px-6 py-3 rounded-lg hover:bg-emerald-600 transition text-center font-medium"
                            >
                              Approve
                            </button>
                          )}
